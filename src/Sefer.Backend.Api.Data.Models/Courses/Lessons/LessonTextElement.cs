...
public class LessonTextElement : ContentBlock, IContentBlock<Lesson, LessonTextElement>
{
    #region Properties
    ...
    public LessonTextElement Predecessor { get; set; }
    ...
    /// <returns></returns>
    /// <inheritdoc />
    public LessonTextElement CreateSuccessor(Lesson lesson)
    {
        var successor = new LessonTextElement
        {
