...
/// </summary>
/// <remarks>
/// Courses and their content will change over time. However, for students it will be problem
/// if the content of the course they followed is not available because an update changed the
/// content. Therefore, Course will feature a CourseRevision. A Course will always have 1
...
public class CourseRevision : Revision, IRevision<CourseRevision>
{
    ...
    /// <summary>
    /// The enrollments that student has on this course revision
    /// </summary>
