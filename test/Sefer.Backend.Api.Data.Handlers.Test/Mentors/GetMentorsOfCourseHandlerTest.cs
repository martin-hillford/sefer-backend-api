...
[TestClass]
public class GetMentorsOfCourseHandlerTest : MentorUnitTest
{
    [TestInitialize]
    ...
    {
        var request = new GetMentorsOfCourseRequest(courseId);
        var handler = new GetMentorsOfCourseHandler(GetServiceProvider().Object);
